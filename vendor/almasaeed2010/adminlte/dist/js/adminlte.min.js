...
function(a) {
	...
	h.prototype.init = function() {
		...
		var collapsed_state = localStorage.getItem('collapsed');
		if(collapsed_state == null){
			if(a(window).width() < this.options.collapseScreenSize ){
				a("body").addClass(f.collapsed).trigger(a.Event(g.collapsed))
				localStorage.setItem('collapsed', 'true');
			}
		}else if(collapsed_state == 'true'){
			a("body").addClass(f.collapsed).trigger(a.Event(g.collapsed))
		}
		...
		a(window).width() > this.options.collapseScreenSize ? a("body").removeClass(f.collapsed).trigger(a.Event(g.expanded)) : a("body").addClass(f.open).removeClass(f.collapsed).trigger(a.Event(g.expanded))
	}, h.prototype.close = function() {
		localStorage.setItem('collapsed', 'true');
		a(window).width() > this.options.collapseScreenSize ? a("body").addClass(f.collapsed).trigger(a.Event(g.collapsed)) : a("body").removeClass(f.open + " " + f.collapsed).addClass(f.collapsed).trigger(a.Event(g.collapsed))
